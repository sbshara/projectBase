...
// TO DO: document the structure and ordering of a FullCalendar lang file
// TO DO: rename everything "lang" to "locale", like what the moment project did
...
// -------------------------------------------------------------------------------------------------
// TO DO: make it work with timezone offset
...
function chunkFormatString(formatStr) {
	var chunks = [];
	var chunker = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; // TO DO: more descrimination
	var match;
...
var Popover = Class.extend({
	...
	// TO DO: better code reuse for this. Repeat code
...
----------------------------------------------------------------------------------------------------------------------*/
// TO DO: very useful to have a handler that gets called upon cellOut OR when dragging stops (for cleanup)
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	colHeadFormat: null, // TO DO: move to another class. not applicable to all Grids
	...
	// TO DO: move to another class. not applicable to all Grids
	...
	/* Event Helper
	------------------------------------------------------------------------------------------------------------------*/
	// TO DO: should probably move this to Grid.events, like we did event dragging / resizing
	...
	// Responsible for populating this.elsByFill. TO DO: better API for expressing this requirement
...
Grid.mixin({
	...
	// Called by the fill system.
	// TO DO: consolidate with getEventSkinCss?
...
var DayGrid = Grid.extend({
	...
	numbersVisible: false, // should render a row for day/week numbers? set by outside view. TO DO: make internal
	...
	------------------------------------------------------------------------------------------------------------------*/
	// TO DO: move to DayGrid.event, similar to what we did with Grid's drag methods
...
DayGrid.mixin({
	...
	computeRowLevelLimit: function(row) {
		...
		var rowHeight = rowEl.height(); // TO DO: cache somehow?
...
var View = fc.View = Class.extend({
	...
	documentMousedownProxy: null, // TO DO: doesn't work with touch
	...
	trigger: function(name, thisObj) { // arguments beyond thisObj are passed along
		...
		return calendar.trigger.apply(
			...
			[name, thisObj || this].concat(
				...
				[ this ] // always make the last argument a reference to the view. TO DO: deprecate
			)
		);
	},
	...
	reportExternalDrop: function(meta, dropLocation, el, ev, ui) {
		...
		// Try to build an event object and render it. TO DO: decouple the two
		if (eventProps) {
	...
	t.getDefaultEventEnd = function(allDay, start) { // TO DO: rename to computeDefaultEventEnd
		var end = start.clone();
	...
	-----------------------------------------------------------------------------*/
	// TO DO: going forward, most of this stuff should be directly handled by the view
...
----------------------------------------------------------------------------------------------------------------------*/
// TO DO: rename all header-related things to "toolbar"
...
function EventManager(options) { // assumed to be a calendar
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// TO DO: repeat code, same code for event classNames
			if (source.className) {
	...
	// TO DO: make this a part of the event -> eventRange system
	...
	//
	// TO DO: don't use so many closures. possible memory issues when lots of events with same ID.
	//
	...
	function isRangeAllowed(range, constraint, overlap, event) {
		...
		if (constraint != null) {
			...
			// TO DO: use ranges in the future
...
var BasicView = fcViews.basic = View.extend({
	...
	render: function() {
		...
		this.dayNumbersVisible = this.dayGrid.rowCnt > 1; // TO DO: make grid responsible
